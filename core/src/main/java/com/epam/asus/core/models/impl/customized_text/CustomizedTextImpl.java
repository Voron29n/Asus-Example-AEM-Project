package com.epam.asus.core.models.impl.customized_text;
...
public class CustomizedTextImpl implements CustomizedText {
    ...
    protected static final String RESOURCE_TYPE = "apps/asus/components/custom/customized-text/v1/customized-text";
